...
Furthermore, AEGIS is key-committing and therefore more resistant against partitioning oracle attacks that affect some existing AEAD schemes, such as AES-GCM {{LGR21}}.
